...
/*Sedikit memodifikasi kode seperti mengganti jumlah musuh yang muncul, kecepatan randomnya dan lainya*/
...
public class Board extends JPanel implements ActionListener {
    ...
    private Image ii;
    private final Color dotColor = new Color(255, 39, 0);
    ...
    private final short levelData[] = {
            ...
            1, 17, 16, 20, 4, 4, 0, 0, 4, 4, 0, 17, 20, 0, 21,
    ...
    private void showIntroScreen(Graphics2D g2d) {
        ...
        String s = "Press N to start Game.";
    ...
    private void drawScore(Graphics2D g) {
        ...
        g.setFont(smallFont);
        g.setColor(new Color(196, 97, 216));
        s = "Score: " + score;
    ...
    private void loadImages() {
        ...
        ghost = new ImageIcon("src/resources/images/hantu.png").getImage();
